...
router.get('/', (req, res) => {
  const users = db.prepare(`
    SELECT u.id, u.name, u.avatar_color, u.created_at,
      ...
      p.protein_target_g, p.carbs_target_g, p.fat_target_g, p.fiber_target_g,
...
router.put('/:id/profile', (req, res) => {
  const {
    ...
    fat_target_g, fiber_target_g, weight_goal_type, target_weight_value,
  ...
  `).run(
    ...
    fiber_target_g ?? null, weight_goal_type ?? null, target_weight_value ?? null,
