/**
 * Muscle SVG path data for front (anterior) and back (posterior) body views.
 *
 * SOURCE: vulovix/body-muscles — https://github.com/vulovix/body-muscles
 * LICENSE: Apache 2.0  (https://github.com/vulovix/body-muscles/blob/main/LICENSE)
 *
 * SVG coordinate system:
 *   Front view — viewBox "0 0 35 93"
 *   Back view  — viewBox "37 0 35 93"
 *
 * Each muscle has a unique `id`, display `name`, `view` side, and SVG `path` (d attribute).
 */
...
// ---------------------------------------------------------------------------
// FRONT (Anterior) muscles  — 54 regions
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// BACK (Posterior) muscles — 54 regions
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Intensity color scale (0 = inactive, 10 = maximum effort)
// ---------------------------------------------------------------------------
